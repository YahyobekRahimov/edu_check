...
export default function SideBar({
  ...
  const locationPath = useAppSelector((state) => state.selectedNav);
  ...
  const menuItems: MenuProps["items"] = [
    {
      ...
      label: <span className="select-none">Guruhlarim</span>,
    ...
    },
    {
      ...
      label: <span className="select-none">O'quvchilar</span>,
    ...
    },
    {
      ...
      label: <span className="select-none">To'lovlar</span>,
    ...
    },
    {
      ...
      label: <span className="select-none">Hisobot</span>,
    ...
    },
    {
      ...
      label: <span className="select-none">Sozlamalar</span>,
  ...
  return (
    <>
      ...
      >
        <img src={Logo} alt="Logo" className="w-[70%] rounded-full" />
      </div>
      <Menu
